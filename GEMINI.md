...
4. **Disparo:** Com a base salva, eu próprio executo a integração local (`wsl claude`) instruindo a máquina do que fazer! Caso o Claude fique pendurado com perguntas do estilo `[Y/n]`, deteto isso via interface e pergunto-te a ti como interagir.
