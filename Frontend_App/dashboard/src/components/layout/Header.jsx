...
const viewTitles = {
  ...
  'financeiro-tarifarios': { title: 'Valor de Inventário', description: 'Valor de substituição dos equipamentos' },
  'financeiro-custos': { title: 'Perdas e Substituições', description: 'Impacto financeiro de perdas e avarias' },
