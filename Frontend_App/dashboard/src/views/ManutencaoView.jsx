...
import { buildCalendarEvents } from '../utils/eventAggregationHelpers';
...
const MaintenanceCalendar = ({ maintenanceRecords, avarias, machines, schedules, getPrediction, setActiveView, onViewRecord, sessions }) => {
  ...
  const eventsByDay = useMemo(() => {
    return buildCalendarEvents(maintenanceRecords, avarias, schedules, machines, getPrediction, parseDate);
