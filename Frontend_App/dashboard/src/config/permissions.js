...
export const MENU_PERMISSIONS = {
  ...
  'financeiro-tarifarios': [PERMISSIONS.FINANCIAL_VIEW, PERMISSIONS.FINANCIAL_TARIFFS],
  'financeiro-custos': [PERMISSIONS.FINANCIAL_VIEW, PERMISSIONS.FINANCIAL_COSTS],
  'financeiro-rentabilidade': [PERMISSIONS.FINANCIAL_VIEW],
