 ...
 *
 * Uso:
 * const machines = useStore(selectMachines);
...
// ============================================
// SELECTORS BÁSICOS (estado direto)
// ============================================
...
// ============================================
// SELECTORS DERIVADOS (computados)
// ============================================
...
// Total de horas todas as máquinas
...
// Operadores ativos (com sessão aberta)
...
// ============================================
// SELECTORS COMBINADOS (múltiplos valores)
// ============================================

// Dashboard stats (usar com shallow compare)
...
// Navigation state (usar com shallow compare)
